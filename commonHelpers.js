import{g as B,a as h,b as C,h as g,c as E,d as $,e as S,i as u}from"./assets/local-storage-b8bcbf79.js";import{b as j}from"./assets/vendor-bfab3ab7.js";const m=document.querySelector(".scroll-up");m.style.display="none";function q(){document.body.scrollTop>400||document.documentElement.scrollTop>400?m.style.display="block":m.style.display="none"}function p(){window.scrollTo({top:0,left:0,behavior:"smooth"})}m.addEventListener("click",p);window.addEventListener("scroll",q);async function M(e){let o=`<li class="categories-list">
               ...
               </li>`}),o}async function y(e){const o=document.querySelector(".current-category");o&&o.classList.remove("current-category");const t=document.querySelector(`a[data-category="${e}"]`);t?t.classList.add("current-category"):console.error(`Element with category "${e}" not found.`)}const b=document.querySelector(".main-page-right");window.addEventListener("resize",()=>{b.innerHTML="",k()});function T(e){return window.innerWidth<768?e.slice(0,1):window.innerWidth>=768&&window.innerWidth<1440?e.slice(0,3):e.slice(0,5)}function A(e){let o=T(e.books),t=e.list_name,s=`
  ...
  </div>`,s}async function _(e){const o=e.map(A).join("");document.querySelector(".main-page-book").insertAdjacentHTML("beforeend",o)}async function k(){const e=document.querySelector(".main-page-right");if(e){e.innerHTML="";let o="";o+=`<h1 class="main-page-title">Best Sellers <span class="main-page-title-span">Books</span></h1>
    <ul class="main-page-book js-main-page-book"></ul>`,e.insertAdjacentHTML("afterbegin",o);const t=await B();await _(t),I()}}k();function H(e){const t=e[0].list_name.split(" "),s=t.slice(0,-1).join(" "),a=t[t.length-1];let i="";return i+=`<h2 id="scroll-to-start" class="main-page-title">${s}<span class="main-page-title-span"> ${a}</span></h2>`,i+='<ul class="main-page-books-render js-main-page-book">',e.forEach(({title:l,_id:c,author:n,book_image:r})=>{i+=`
    <li class="main-page-book-render-item">
    <div class="book-card">
