import{g as B,a as h,b as E,h as g,c as $,d as C,e as S}from"./assets/local-storage-22d1bda9.js";import{b as j}from"./assets/vendor-bfab3ab7.js";const m=document.querySelector(".scroll-up");m.style.display="none";function q(){document.body.scrollTop>400||document.documentElement.scrollTop>400?m.style.display="block":m.style.display="none"}function p(){window.scrollTo({top:0,left:0,behavior:"smooth"})}m.addEventListener("click",p);window.addEventListener("scroll",q);async function M(e){let o=`<li class="categories-list">
               ...
               </li>`}),o}async function y(e){const o=document.querySelector(".current-category");o&&o.classList.remove("current-category");const t=document.querySelector(`a[data-category="${e}"]`);t?t.classList.add("current-category"):console.error(`Element with category "${e}" not found.`)}const k=document.querySelector(".main-page-right");window.addEventListener("resize",()=>{k.innerHTML="",b()});function T(e){return window.innerWidth<768?e.slice(0,1):window.innerWidth>=768&&window.innerWidth<1440?e.slice(0,3):e.slice(0,5)}function A(e){let o=T(e.books),t=e.list_name,s=`
  ...
  </li>`}),i+="</ul>",i}function v(e){k.innerHTML="";const o=H(e);k.insertAdjacentHTML("afterbegin",o)}function I(){document.querySelectorAll(".button-see-more").forEach(o=>{o.addEventListener("click",async function(){const t=this.dataset.catname,s=await h(t);v(s),y(t),document.getElementById("scroll-to-start").scrollIntoView({behavior:"smooth"}),p()})})}const f={category:document.querySelector(".categories-elements"),pageHeader:document.querySelector(".header-home")};N();async function N(){try{const e=await E();f.category.insertAdjacentHTML("beforeend",await M(e)),document.querySelectorAll(".category-link").forEach(o=>{o.addEventListener("click",W)})}catch{}}async function W(e){e.preventDefault();const o=e.target.textContent.trim();if(o==="All categories")b(),y(e.target.dataset.category),document.getElementById("scroll-to-start").scrollIntoView({behavior:"smooth"});else{const t=await h(o);v(t),y(e.target.dataset.category),document.getElementById("scroll-to-start").scrollIntoView({behavior:"smooth"})}}window.addEventListener("DOMContentLoaded",e=>{f.pageHeader.dataset.pageName="home"});const u="/911/assets/sprite-a9c1b5d7.svg";function x(e){const o=j.create(`<div class="book-modal">
